document.addEventListener("DOMContentLoaded", function () {
  ...
  const closeModalBtnDansAjoutPhoto = document.getElementById(
    "closeModalBtnDansAjoutPhoto"
  );
...
document
  ...
  .addEventListener("click", afficherModaleAjoutPhoto);
...
document
  ...
  .addEventListener("click", afficherModalePrincipale);
